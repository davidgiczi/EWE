...
public class CollectPillarSectionMeasurementData {
	...
	public List<MeasPoint> leftTheUppestWirePointList;
	public List<MeasPoint> mediumTheUppestWirePointList;
	...
	public CollectPillarSectionMeasurementData(String startPillarId, String endPillarId, List<String> measDataList) 
		...
		parseLeftTheUppestWirePointList();
		parseMediumTheUppestWirePointList();
		parseRightTheUppestWirePointList();
		parseLeftMediumWirePointList();
		parseRightMediumWirePointList();
	...
	private void validatePillarInputData() throws InvalidAttributeValueException {
		...
		for(MeasPoint measPoint : startPillarPointList) {
			if( measPoint.pointType.equals(POINT_TYPE[6]) ) {
				basePoint++;
			}
	...
	private void validateInputWireData() throws InvalidAttributesException, InvalidAttributeValueException {
		if( leftOutsideWirePointList.isEmpty() &&
			...
			leftTheUppestWirePointList.isEmpty() &&
			mediumTheUppestWirePointList.isEmpty() &&
			rightTheUppestWirePointList.isEmpty() &&
			leftMediumWirePointList.isEmpty() &&
			rightMediumWirePointList.isEmpty() ) {
		...
		isValidListFor(leftTheUppestWirePointList);
		isValidListFor(mediumTheUppestWirePointList);
		isValidListFor(rightTheUppestWirePointList);
		isValidListFor(leftMediumWirePointList);
		isValidListFor(rightMediumWirePointList);
	}
	...
	private void isValidListFor(List<MeasPoint> wirePointList) throws InvalidAttributeValueException{
		...
		for (MeasPoint wirePoint1 : wirePointList) {
			...
			for (MeasPoint wirePoint2 : wirePointList) {
				...
				if( wirePoint1.pointId.endsWith(POINT_TYPE[8]) ) {
					isSingle = false;
				}
				else if( wirePoint1.pointId.endsWith(POINT_TYPE[10]) ) {
					isSingle = false;
				}
				else if( wirePoint1.pointId.endsWith(POINT_TYPE[11]) && 
				...
				else if( (wirePoint1.pointId + "-" + POINT_TYPE[11]).equals(wirePoint2.pointId) 
						&& wirePoint1.isUpper != wirePoint2.isUpper) {
					isSingle = false;
				}
	...
	private void parseMediumTheUppestWirePointList() {
		mediumTheUppestWirePointList = new ArrayList<>();
		for( String measDataRow : measDataList ) {
			...
			String[] pointIdData = rowData[0].split("-");
			String pointId = POINT_TYPE[3] + "-" + startPillarId + "-" + endPillarId + "-";		
			...
			if( !isTPSMeasure && rowData[0].toUpperCase().startsWith(pointId) &&
				...
				mediumWirePoint.setPointY(Double.parseDouble(rowData[2]));
				mediumWirePoint.setPointZ(Double.parseDouble(rowData[3]));
				mediumWirePoint.setPointType(POINT_TYPE[3]);
				mediumWirePoint.setUpper(false);
	...
	private void parseLeftTheUppestWirePointList() {
		leftTheUppestWirePointList = new ArrayList<>();
		for( String measDataRow : measDataList ) {
			...
			if( !isTPSMeasure && rowData[0].toUpperCase().startsWith(pointId) &&
				...
				wirePoint.setPointY(Double.parseDouble(rowData[2]));
				wirePoint.setPointZ(Double.parseDouble(rowData[3]));
				wirePoint.setPointType(POINT_TYPE[0] + "-" + POINT_TYPE[3]);
				wirePoint.setUpper(false);
	...
	private void parseRightTheUppestWirePointList() {
		rightTheUppestWirePointList = new ArrayList<>();
		for( String measDataRow : measDataList ) {
			...
			if( !isTPSMeasure && rowData[0].toUpperCase().startsWith(pointId) &&
				...
				wirePoint.setPointY(Double.parseDouble(rowData[2]));
				wirePoint.setPointZ(Double.parseDouble(rowData[3]));
				wirePoint.setPointType(POINT_TYPE[1] + "-" + POINT_TYPE[3]);
				wirePoint.setUpper(false);
	...
	private void parseLeftMediumWirePointList() {
		leftMediumWirePointList = new ArrayList<>();
		for( String measDataRow : measDataList ) {
			...
			String[] pointIdData = rowData[0].split("-");
			String pointId = POINT_TYPE[0] + "-" + POINT_TYPE[2] + "-" + startPillarId + "-" + endPillarId + "-";		
			...
			if( !isTPSMeasure && rowData[0].toUpperCase().startsWith(pointId) &&
				...
				leftWirePoint.setPointY(Double.parseDouble(rowData[2]));
				leftWirePoint.setPointZ(Double.parseDouble(rowData[3]));
				leftWirePoint.setPointType(POINT_TYPE[0] + "-" + POINT_TYPE[2]);
				leftWirePoint.setUpper(false);
	...
	private void parseRightOutSideWirePointList() {
		...
		for( String measDataRow : measDataList ) {
			...
			String[] pointIdData = rowData[0].split("-");
			String pointId = POINT_TYPE[1] + "-" + POINT_TYPE[4] + "-" + startPillarId + "-" + endPillarId + "-";		
			...
			if( !isTPSMeasure && rowData[0].toUpperCase().startsWith(pointId) &&
				...
				rightWirePoint.setPointY(Double.parseDouble(rowData[2]));
				rightWirePoint.setPointZ(Double.parseDouble(rowData[3]));
				rightWirePoint.setPointType(POINT_TYPE[1] + "-" + POINT_TYPE[4]);
				rightWirePoint.setUpper(false);
				rightOutsideWirePointList.add(rightWirePoint);
			}
			else if( isTPSMeasure && rowData[0].toUpperCase().startsWith(pointId) &&
	...
	private void parseRightMediumWirePointList() {
		rightMediumWirePointList = new ArrayList<>();
		for( String measDataRow : measDataList ) {
			...
			String[] pointIdData = rowData[0].split("-");
			String pointId = POINT_TYPE[1] + "-" + POINT_TYPE[2] + "-" + startPillarId + "-" + endPillarId + "-";		
			...
			if( !isTPSMeasure && rowData[0].toUpperCase().startsWith(pointId) &&
				...
				rightWirePoint.setPointY(Double.parseDouble(rowData[2]));
				rightWirePoint.setPointZ(Double.parseDouble(rowData[3]));
				rightWirePoint.setPointType(POINT_TYPE[1] + "-" + POINT_TYPE[2]);
				rightWirePoint.setUpper(false);
	...
	private void parseLeftInSideWirePointList() {
		...
		for( String measDataRow : measDataList ) {
			...
			if( !isTPSMeasure && rowData[0].toUpperCase().startsWith(pointId) &&
				...
				leftWirePoint.setPointY(Double.parseDouble(rowData[2]));
				leftWirePoint.setPointZ(Double.parseDouble(rowData[3]));
				leftWirePoint.setPointType(POINT_TYPE[0] + "-" + POINT_TYPE[5]);
				leftWirePoint.setUpper(false);
	...
	private void parseRightInSideWirePointList() {
		...
		for( String measDataRow : measDataList ) {
			...
			String[] pointIdData = rowData[0].split("-");
			String pointId = POINT_TYPE[1] + "-" + POINT_TYPE[5] + "-" + startPillarId + "-" + endPillarId + "-";		
			...
			if( !isTPSMeasure && rowData[0].toUpperCase().startsWith(pointId) &&
				...
				rightWirePoint.setPointY(Double.parseDouble(rowData[2]));
				rightWirePoint.setPointZ(Double.parseDouble(rowData[3]));
				rightWirePoint.setPointType(POINT_TYPE[1] + "-" + POINT_TYPE[5]);
				rightWirePoint.setUpper(false);
	...
	private void parseStartPillarPointListData() {
		...
		for( String measDataRow : measDataList ) {
			...
			if( pillarId[0].equalsIgnoreCase(startPillarId) && 
				...
				basePoint.setPointType(POINT_TYPE[6]);
				...
				topPoint.setPointType(POINT_TYPE[7]);
				startPillarPointList.add(topPoint);
			}
			else if( rowData[0].equalsIgnoreCase(POINT_TYPE[0] + "-" + startPillarId + "-" + POINT_TYPE[9]) ) {
				MeasPoint leftPoint = new MeasPoint();
				leftPoint.setPointId(POINT_TYPE[0] + "-" + startPillarId + "-" +  POINT_TYPE[9]);
				...
				leftPoint.setPointType(POINT_TYPE[0] + "-" + POINT_TYPE[9]);
				leftPoint.setUpper(isTPSMeasure);
				startPillarPointList.add(leftPoint);
				isGrabbedId = true;
			}
			else if( rowData[0].equalsIgnoreCase(POINT_TYPE[1] + "-" + startPillarId + "-" + POINT_TYPE[9]) ) {
				MeasPoint rightPoint = new MeasPoint();
				rightPoint.setPointId(POINT_TYPE[1] + "-" + startPillarId + "-" +  POINT_TYPE[9]);
				...
				rightPoint.setPointType(POINT_TYPE[1] + "-" + POINT_TYPE[9]);
				rightPoint.setUpper(isTPSMeasure);
				startPillarPointList.add(rightPoint);
				isGrabbedId = true;
			}
			else if( rowData[0].equalsIgnoreCase(POINT_TYPE[2] + "-" + startPillarId + "-" + POINT_TYPE[9]) ) {
				MeasPoint mediumPoint = new MeasPoint();
				mediumPoint.setPointId(POINT_TYPE[2] + "-" + startPillarId + "-" +  POINT_TYPE[9]);
				...
				mediumPoint.setPointType(POINT_TYPE[2] + "-" + POINT_TYPE[9]);
				mediumPoint.setUpper(isTPSMeasure);
				startPillarPointList.add(mediumPoint);
				isGrabbedId = true;
			}
			else if( rowData[0].equalsIgnoreCase(POINT_TYPE[0] + "-" + POINT_TYPE[4] + "-" + startPillarId + "-" + POINT_TYPE[9]) ) {
				MeasPoint leftOutPoint = new MeasPoint();
				leftOutPoint.setPointId(POINT_TYPE[0] + "-" + POINT_TYPE[4] + "-" + startPillarId + "-" +  POINT_TYPE[9]);
				...
				leftOutPoint.setPointType(POINT_TYPE[0] + "-" + POINT_TYPE[4] + "-" + POINT_TYPE[9]);
				leftOutPoint.setUpper(isTPSMeasure);
				startPillarPointList.add(leftOutPoint);
				isGrabbedId = true;
			}
			else if( rowData[0].equalsIgnoreCase(POINT_TYPE[0] + "-" + POINT_TYPE[5] + "-" + startPillarId + "-" + POINT_TYPE[9]) ) {
				MeasPoint leftInPoint = new MeasPoint();
				leftInPoint.setPointId(POINT_TYPE[0] + "-" + POINT_TYPE[5] + "-" + startPillarId + "-" +  POINT_TYPE[9]);
				...
				leftInPoint.setPointType(POINT_TYPE[0] + "-" + POINT_TYPE[5] + "-" + POINT_TYPE[9]);
				leftInPoint.setUpper(isTPSMeasure);
				startPillarPointList.add(leftInPoint);
				isGrabbedId = true;
			}
			else if( rowData[0].equalsIgnoreCase(POINT_TYPE[1] + "-" +  POINT_TYPE[5] + "-" + startPillarId + "-" + POINT_TYPE[9]) ) {
				MeasPoint rightInPoint = new MeasPoint();
				rightInPoint.setPointId(POINT_TYPE[1] + "-" + POINT_TYPE[5] + "-" + startPillarId + "-" +  POINT_TYPE[9]);
				...
				rightInPoint.setPointType(POINT_TYPE[1] + "-" + POINT_TYPE[5] + "-" + POINT_TYPE[9]);
				rightInPoint.setUpper(isTPSMeasure);
				startPillarPointList.add(rightInPoint);
				isGrabbedId = true;
			}
			else if( rowData[0].equalsIgnoreCase(POINT_TYPE[1] + "-" + POINT_TYPE[4] + "-" + startPillarId + "-" + POINT_TYPE[9]) ) {
				MeasPoint rightOutPoint = new MeasPoint();
				rightOutPoint.setPointId(POINT_TYPE[1] + "-" + POINT_TYPE[4] + "-" + startPillarId + "-" +  POINT_TYPE[9]);
				...
				rightOutPoint.setPointType(POINT_TYPE[1] + "-" + POINT_TYPE[4] + "-" + POINT_TYPE[9]);
				rightOutPoint.setUpper(isTPSMeasure);
				startPillarPointList.add(rightOutPoint);
				isGrabbedId = true;
			}
			else if( rowData[0].equalsIgnoreCase(POINT_TYPE[0] + "-" + POINT_TYPE[3] + "-" + startPillarId + "-" + POINT_TYPE[9]) ) {
				MeasPoint leftUppestPoint = new MeasPoint();
				leftUppestPoint.setPointId(POINT_TYPE[0] + "-" + POINT_TYPE[3] + "-" + startPillarId + "-" +  POINT_TYPE[9]);
				...
				leftUppestPoint.setPointType(POINT_TYPE[0] + "-" + POINT_TYPE[3] + "-" + POINT_TYPE[9]);
				leftUppestPoint.setUpper(isTPSMeasure);
				startPillarPointList.add(leftUppestPoint);
				isGrabbedId = true;
			}
			else if( rowData[0].equalsIgnoreCase(POINT_TYPE[3] + "-" + startPillarId + "-" + POINT_TYPE[9]) ) {
				MeasPoint mediumUppestPoint = new MeasPoint();
				mediumUppestPoint.setPointId(POINT_TYPE[3] + "-" + startPillarId + "-" +  POINT_TYPE[9]);
				...
				mediumUppestPoint.setPointType(POINT_TYPE[3] + "-" + POINT_TYPE[9]);
				mediumUppestPoint.setUpper(isTPSMeasure);
				startPillarPointList.add(mediumUppestPoint);
				isGrabbedId = true;
			}
			else if( rowData[0].equalsIgnoreCase(POINT_TYPE[1] + "-" + POINT_TYPE[3] + "-" + startPillarId + "-" + POINT_TYPE[9]) ) {
				MeasPoint leftUppestPoint = new MeasPoint();
				leftUppestPoint.setPointId(POINT_TYPE[1] + "-" + POINT_TYPE[3] + "-" + startPillarId + "-" +  POINT_TYPE[9]);
				leftUppestPoint.setPointX(Double.parseDouble(rowData[1]));
				leftUppestPoint.setPointY(Double.parseDouble(rowData[2]));
				leftUppestPoint.setPointZ(Double.parseDouble(rowData[3]));
				leftUppestPoint.setPointType(POINT_TYPE[1] + "-" + POINT_TYPE[3] + "-" + POINT_TYPE[9]);
				leftUppestPoint.setUpper(isTPSMeasure);
				startPillarPointList.add(leftUppestPoint);
				isGrabbedId = true;
			}
			else if( rowData[0].equalsIgnoreCase(POINT_TYPE[0] + "-" + POINT_TYPE[2] + "-" + startPillarId + "-" + POINT_TYPE[9]) ) {
				MeasPoint leftMediumPoint = new MeasPoint();
				leftMediumPoint.setPointId(POINT_TYPE[0] + "-" + POINT_TYPE[2] + "-" + startPillarId + "-" +  POINT_TYPE[9]);
				...
				leftMediumPoint.setPointType(POINT_TYPE[0] + "-" + POINT_TYPE[2] + "-" + POINT_TYPE[9]);
				leftMediumPoint.setUpper(isTPSMeasure);
				startPillarPointList.add(leftMediumPoint);
				isGrabbedId = true;
			}
			else if( rowData[0].equalsIgnoreCase(POINT_TYPE[1] + "-" + POINT_TYPE[2] + "-" + startPillarId + "-" + POINT_TYPE[9]) ) {
				MeasPoint rightMediumPoint = new MeasPoint();
				rightMediumPoint.setPointId(POINT_TYPE[1] + "-" + POINT_TYPE[2] + "-" + startPillarId + "-" +  POINT_TYPE[9]);
			...
			if( rowData[0].equalsIgnoreCase(POINT_TYPE[0] + "-" + startPillarId + "-" + endPillarId + "-"  + POINT_TYPE[9]) ) {
				MeasPoint leftPoint = new MeasPoint();
				leftPoint.setPointId(POINT_TYPE[0] + "-" + startPillarId + "-" + endPillarId + "-"  +  POINT_TYPE[9]);
				leftPoint.setPointX(Double.parseDouble(rowData[1]));
				leftPoint.setPointY(Double.parseDouble(rowData[2]));
				leftPoint.setPointZ(Double.parseDouble(rowData[3]));
				leftPoint.setPointType(POINT_TYPE[0] + "-" + POINT_TYPE[9]);
			...
			else if( rowData[0].equalsIgnoreCase( POINT_TYPE[1] + "-" + startPillarId + "-" + endPillarId + "-"  + POINT_TYPE[9]) ) {
				MeasPoint rightPoint = new MeasPoint();
				rightPoint.setPointId(POINT_TYPE[1] + "-" + startPillarId + "-" + endPillarId + "-"  +  POINT_TYPE[9]);
				rightPoint.setPointX(Double.parseDouble(rowData[1]));
				rightPoint.setPointY(Double.parseDouble(rowData[2]));
				rightPoint.setPointZ(Double.parseDouble(rowData[3]));
				rightPoint.setPointType(POINT_TYPE[1] + "-" + POINT_TYPE[9]);
			...
			else if( rowData[0].equalsIgnoreCase( POINT_TYPE[2] + "-" + startPillarId + "-" + endPillarId + "-"  + POINT_TYPE[9]) ) {
				MeasPoint mediumPoint = new MeasPoint();
				mediumPoint.setPointId(POINT_TYPE[2] + "-" + startPillarId + "-" + endPillarId + "-"  +  POINT_TYPE[9]);
				mediumPoint.setPointX(Double.parseDouble(rowData[1]));
				mediumPoint.setPointY(Double.parseDouble(rowData[2]));
				mediumPoint.setPointZ(Double.parseDouble(rowData[3]));
				mediumPoint.setPointType(POINT_TYPE[2] + "-" + POINT_TYPE[9]);
				...
				startPillarId + "-" + endPillarId + "-"  + POINT_TYPE[9]) ) {
				MeasPoint leftOutPoint = new MeasPoint();
				leftOutPoint.setPointId(POINT_TYPE[0] + "-" + POINT_TYPE[4] + "-" + startPillarId + "-" + endPillarId + "-"  +  POINT_TYPE[9]);
				leftOutPoint.setPointX(Double.parseDouble(rowData[1]));
				leftOutPoint.setPointY(Double.parseDouble(rowData[2]));
				leftOutPoint.setPointZ(Double.parseDouble(rowData[3]));
				leftOutPoint.setPointType(POINT_TYPE[0] + "-" + POINT_TYPE[4] + "-" + POINT_TYPE[9]);
				...
				startPillarId + "-" + endPillarId + "-"  + POINT_TYPE[9]) ) {
				MeasPoint leftInPoint = new MeasPoint();
				leftInPoint.setPointId(POINT_TYPE[0] + "-" + POINT_TYPE[5] + "-" + startPillarId + "-" + endPillarId + "-"  +  POINT_TYPE[9]);
				leftInPoint.setPointX(Double.parseDouble(rowData[1]));
				leftInPoint.setPointY(Double.parseDouble(rowData[2]));
				leftInPoint.setPointZ(Double.parseDouble(rowData[3]));
				leftInPoint.setPointType(POINT_TYPE[0] + "-" + POINT_TYPE[5] + "-" + POINT_TYPE[9]);
				...
				startPillarId + "-" + endPillarId + "-"  + POINT_TYPE[9]) ) {
				MeasPoint rightInPoint = new MeasPoint();
				rightInPoint.setPointId(POINT_TYPE[1] + "-" + POINT_TYPE[5] + "-" + startPillarId + "-" + endPillarId + "-"  +  POINT_TYPE[9]);
				rightInPoint.setPointX(Double.parseDouble(rowData[1]));
				rightInPoint.setPointY(Double.parseDouble(rowData[2]));
				rightInPoint.setPointZ(Double.parseDouble(rowData[3]));
				rightInPoint.setPointType(POINT_TYPE[1] + "-" + POINT_TYPE[5] + "-" + POINT_TYPE[9]);
			...
			else if( rowData[0].equalsIgnoreCase(POINT_TYPE[3] + "-" + startPillarId + "-" + endPillarId + "-"  + POINT_TYPE[9]) ) {
				MeasPoint mediumUppestPoint = new MeasPoint();
				mediumUppestPoint.setPointId(POINT_TYPE[3] + "-" + startPillarId + "-" + endPillarId + "-"  +  POINT_TYPE[9]);
				mediumUppestPoint.setPointX(Double.parseDouble(rowData[1]));
				mediumUppestPoint.setPointY(Double.parseDouble(rowData[2]));
				mediumUppestPoint.setPointZ(Double.parseDouble(rowData[3]));
				mediumUppestPoint.setPointType(POINT_TYPE[3] + "-" + POINT_TYPE[9]);
				...
				rightUppestPoint.setPointType(POINT_TYPE[1] + "-" + POINT_TYPE[3] + "-" + POINT_TYPE[9]);
	...
	private void parseEndPillarPointListData() {
		...
		for( String measDataRow : measDataList ) {
			...
			else if( rowData[0].equalsIgnoreCase(POINT_TYPE[0] + "-" + endPillarId + "-" + POINT_TYPE[9]) ) {
				MeasPoint leftPoint = new MeasPoint();
				leftPoint.setPointId(POINT_TYPE[0] + "-" + endPillarId + "-" +  POINT_TYPE[9]);
				leftPoint.setPointX(Double.parseDouble(rowData[1]));
				leftPoint.setPointY(Double.parseDouble(rowData[2]));
				leftPoint.setPointZ(Double.parseDouble(rowData[3]));
				leftPoint.setPointType(POINT_TYPE[0] + "-" + POINT_TYPE[9]);
			...
			else if( rowData[0].equalsIgnoreCase( POINT_TYPE[1] + "-" + endPillarId + "-" + POINT_TYPE[9]) ) {
				MeasPoint rightPoint = new MeasPoint();
				rightPoint.setPointId(POINT_TYPE[1] + "-" + endPillarId + "-" +  POINT_TYPE[9]);
				rightPoint.setPointX(Double.parseDouble(rowData[1]));
				rightPoint.setPointY(Double.parseDouble(rowData[2]));
				rightPoint.setPointZ(Double.parseDouble(rowData[3]));
				rightPoint.setPointType(POINT_TYPE[1] + "-" + POINT_TYPE[9]);
			...
			else if( rowData[0].equalsIgnoreCase( POINT_TYPE[2] + "-" + endPillarId + "-" + POINT_TYPE[9]) ) {
				MeasPoint mediumPoint = new MeasPoint();
				mediumPoint.setPointId(POINT_TYPE[2] + "-" + endPillarId + "-" +  POINT_TYPE[9]);
				mediumPoint.setPointX(Double.parseDouble(rowData[1]));
				mediumPoint.setPointY(Double.parseDouble(rowData[2]));
				mediumPoint.setPointZ(Double.parseDouble(rowData[3]));
				mediumPoint.setPointType(POINT_TYPE[2] + "-" + POINT_TYPE[9]);
			...
			else if( rowData[0].equalsIgnoreCase(POINT_TYPE[0] + "-" + POINT_TYPE[4] + "-" + endPillarId + "-" + POINT_TYPE[9]) ) {
				MeasPoint leftOutPoint = new MeasPoint();
				leftOutPoint.setPointId(POINT_TYPE[0] + "-" + POINT_TYPE[4] + "-" + endPillarId + "-" +  POINT_TYPE[9]);
				leftOutPoint.setPointX(Double.parseDouble(rowData[1]));
				leftOutPoint.setPointY(Double.parseDouble(rowData[2]));
				leftOutPoint.setPointZ(Double.parseDouble(rowData[3]));
				leftOutPoint.setPointType(POINT_TYPE[0] + "-" + POINT_TYPE[4] + "-" + POINT_TYPE[9]);
			...
			else if( rowData[0].equalsIgnoreCase(POINT_TYPE[0] + "-" + POINT_TYPE[5] + "-" + endPillarId + "-" + POINT_TYPE[9]) ) {
				MeasPoint leftInPoint = new MeasPoint();
				leftInPoint.setPointId(POINT_TYPE[0] + "-" + POINT_TYPE[5] + "-" + endPillarId + "-" +  POINT_TYPE[9]);
				leftInPoint.setPointX(Double.parseDouble(rowData[1]));
				leftInPoint.setPointY(Double.parseDouble(rowData[2]));
				leftInPoint.setPointZ(Double.parseDouble(rowData[3]));
				leftInPoint.setPointType(POINT_TYPE[0] + "-" + POINT_TYPE[5] + "-" + POINT_TYPE[9]);
			...
			else if( rowData[0].equalsIgnoreCase(POINT_TYPE[1] + "-" +  POINT_TYPE[5] + "-" + endPillarId + "-" + POINT_TYPE[9]) ) {
				MeasPoint rightInPoint = new MeasPoint();
				rightInPoint.setPointId(POINT_TYPE[1] + "-" + POINT_TYPE[5] + "-" + endPillarId + "-" +  POINT_TYPE[9]);
				rightInPoint.setPointX(Double.parseDouble(rowData[1]));
				rightInPoint.setPointY(Double.parseDouble(rowData[2]));
				rightInPoint.setPointZ(Double.parseDouble(rowData[3]));
				rightInPoint.setPointType(POINT_TYPE[1] + "-" + POINT_TYPE[5] + "-" + POINT_TYPE[9]);
			...
			else if( rowData[0].equalsIgnoreCase(POINT_TYPE[1] + "-" + POINT_TYPE[4] + "-" + endPillarId + "-" + POINT_TYPE[9]) ) {
				MeasPoint rightOutPoint = new MeasPoint();
				rightOutPoint.setPointId(POINT_TYPE[1] + "-" + POINT_TYPE[4] + "-" + endPillarId + "-" +  POINT_TYPE[9]);
				rightOutPoint.setPointX(Double.parseDouble(rowData[1]));
				rightOutPoint.setPointY(Double.parseDouble(rowData[2]));
				rightOutPoint.setPointZ(Double.parseDouble(rowData[3]));
				rightOutPoint.setPointType(POINT_TYPE[1] + "-" + POINT_TYPE[4] + "-" + POINT_TYPE[9]);
			...
			else if( rowData[0].equalsIgnoreCase(POINT_TYPE[0] + "-" + POINT_TYPE[3] + "-" + endPillarId + "-" + POINT_TYPE[9]) ) {
				MeasPoint leftUppestPoint = new MeasPoint();
				leftUppestPoint.setPointId(POINT_TYPE[0] + "-" + POINT_TYPE[3] + "-" + endPillarId + "-" +  POINT_TYPE[9]);
				leftUppestPoint.setPointX(Double.parseDouble(rowData[1]));
				leftUppestPoint.setPointY(Double.parseDouble(rowData[2]));
				leftUppestPoint.setPointZ(Double.parseDouble(rowData[3]));
				leftUppestPoint.setPointType(POINT_TYPE[0] + "-" + POINT_TYPE[3] + "-" + POINT_TYPE[9]);
			...
			else if( rowData[0].equalsIgnoreCase(POINT_TYPE[3] + "-" + endPillarId + "-" + POINT_TYPE[9]) ) {
				MeasPoint mediumUppestPoint = new MeasPoint();
				mediumUppestPoint.setPointId(POINT_TYPE[3] + "-" + endPillarId + "-" +  POINT_TYPE[9]);
				mediumUppestPoint.setPointX(Double.parseDouble(rowData[1]));
				mediumUppestPoint.setPointY(Double.parseDouble(rowData[2]));
				mediumUppestPoint.setPointZ(Double.parseDouble(rowData[3]));
				mediumUppestPoint.setPointType(POINT_TYPE[3] + "-" + POINT_TYPE[9]);
			...
			else if( rowData[0].equalsIgnoreCase(POINT_TYPE[1] + "-" + POINT_TYPE[3] + "-" + endPillarId + "-" + POINT_TYPE[9]) ) {
				MeasPoint leftUppestPoint = new MeasPoint();
				leftUppestPoint.setPointId(POINT_TYPE[1] + "-" + POINT_TYPE[3] + "-" + endPillarId + "-" +  POINT_TYPE[9]);
				leftUppestPoint.setPointX(Double.parseDouble(rowData[1]));
				leftUppestPoint.setPointY(Double.parseDouble(rowData[2]));
				leftUppestPoint.setPointZ(Double.parseDouble(rowData[3]));
				leftUppestPoint.setPointType(POINT_TYPE[1] + "-" + POINT_TYPE[3] + "-" + POINT_TYPE[9]);
			...
			else if( rowData[0].equalsIgnoreCase(POINT_TYPE[0] + "-" + POINT_TYPE[2] + "-" + endPillarId + "-" + POINT_TYPE[9]) ) {
				MeasPoint leftMediumPoint = new MeasPoint();
				leftMediumPoint.setPointId(POINT_TYPE[0] + "-" + POINT_TYPE[2] + "-" + endPillarId + "-" +  POINT_TYPE[9]);
				leftMediumPoint.setPointX(Double.parseDouble(rowData[1]));
				leftMediumPoint.setPointY(Double.parseDouble(rowData[2]));
				leftMediumPoint.setPointZ(Double.parseDouble(rowData[3]));
				leftMediumPoint.setPointType(POINT_TYPE[0] + "-" + POINT_TYPE[2] + "-" + POINT_TYPE[9]);
			...
			else if( rowData[0].equalsIgnoreCase(POINT_TYPE[1] + "-" + POINT_TYPE[2] + "-" + endPillarId + "-" + POINT_TYPE[9]) ) {
				MeasPoint rightMediumPoint = new MeasPoint();
				rightMediumPoint.setPointId(POINT_TYPE[1] + "-" + POINT_TYPE[2] + "-" + endPillarId + "-" +  POINT_TYPE[9]);
				rightMediumPoint.setPointX(Double.parseDouble(rowData[1]));
				rightMediumPoint.setPointY(Double.parseDouble(rowData[2]));
				rightMediumPoint.setPointZ(Double.parseDouble(rowData[3]));
				rightMediumPoint.setPointType(POINT_TYPE[1] + "-" + POINT_TYPE[2] + "-" + POINT_TYPE[9]);
			...
			if( rowData[0].equalsIgnoreCase(POINT_TYPE[0] + "-" + endPillarId + "-" + startPillarId + "-" + POINT_TYPE[9]) ) {
				MeasPoint leftPoint = new MeasPoint();
				leftPoint.setPointId(POINT_TYPE[0] + "-" + endPillarId + "-" + startPillarId + "-" +   POINT_TYPE[9]);
				leftPoint.setPointX(Double.parseDouble(rowData[1]));
				leftPoint.setPointY(Double.parseDouble(rowData[2]));
				leftPoint.setPointZ(Double.parseDouble(rowData[3]));
				leftPoint.setPointType(POINT_TYPE[0] + "-" + POINT_TYPE[9]);
			...
			else if( rowData[0].equalsIgnoreCase( POINT_TYPE[1] + "-" + endPillarId + "-" + startPillarId + "-" + POINT_TYPE[9]) ) {
				MeasPoint rightPoint = new MeasPoint();
				rightPoint.setPointId(POINT_TYPE[1] + "-" + endPillarId + "-" + startPillarId + "-" +  POINT_TYPE[9]);
				rightPoint.setPointX(Double.parseDouble(rowData[1]));
				rightPoint.setPointY(Double.parseDouble(rowData[2]));
				rightPoint.setPointZ(Double.parseDouble(rowData[3]));
				rightPoint.setPointType(POINT_TYPE[1] + "-" + POINT_TYPE[9]);
			...
			else if( rowData[0].equalsIgnoreCase( POINT_TYPE[2] + "-" + endPillarId + "-" + startPillarId + "-" + POINT_TYPE[9]) ) {
				MeasPoint mediumPoint = new MeasPoint();
				mediumPoint.setPointId(POINT_TYPE[2] + "-" + endPillarId + "-" + startPillarId + "-" +  POINT_TYPE[9]);
				mediumPoint.setPointX(Double.parseDouble(rowData[1]));
				mediumPoint.setPointY(Double.parseDouble(rowData[2]));
				mediumPoint.setPointZ(Double.parseDouble(rowData[3]));
				mediumPoint.setPointType(POINT_TYPE[2] + "-" + POINT_TYPE[9]);
				...
				endPillarId + "-" + startPillarId + "-" + POINT_TYPE[9]) ) {
				MeasPoint leftOutPoint = new MeasPoint();
				leftOutPoint.setPointId(POINT_TYPE[0] + "-" + POINT_TYPE[4] + "-" + endPillarId + "-" + startPillarId + "-" +  POINT_TYPE[9]);
				leftOutPoint.setPointX(Double.parseDouble(rowData[1]));
				leftOutPoint.setPointY(Double.parseDouble(rowData[2]));
				leftOutPoint.setPointZ(Double.parseDouble(rowData[3]));
				leftOutPoint.setPointType(POINT_TYPE[0] + "-" + POINT_TYPE[4] + "-" + POINT_TYPE[9]);
				...
				endPillarId + "-" + startPillarId + "-" + POINT_TYPE[9]) ) {
				MeasPoint leftInPoint = new MeasPoint();
				leftInPoint.setPointId(POINT_TYPE[0] + "-" + POINT_TYPE[5] + "-" + endPillarId + "-" + startPillarId + "-" +  POINT_TYPE[9]);
				leftInPoint.setPointX(Double.parseDouble(rowData[1]));
				leftInPoint.setPointY(Double.parseDouble(rowData[2]));
				leftInPoint.setPointZ(Double.parseDouble(rowData[3]));
				leftInPoint.setPointType(POINT_TYPE[0] + "-" + POINT_TYPE[5] + "-" + POINT_TYPE[9]);
				...
				endPillarId + "-" + startPillarId + "-" + POINT_TYPE[9]) ) {
				MeasPoint rightInPoint = new MeasPoint();
				rightInPoint.setPointId(POINT_TYPE[1] + "-" + POINT_TYPE[5] + "-" + endPillarId + "-" + startPillarId + "-" +  POINT_TYPE[9]);
				rightInPoint.setPointX(Double.parseDouble(rowData[1]));
				rightInPoint.setPointY(Double.parseDouble(rowData[2]));
				rightInPoint.setPointZ(Double.parseDouble(rowData[3]));
				rightInPoint.setPointType(POINT_TYPE[1] + "-" + POINT_TYPE[5] + "-" + POINT_TYPE[9]);
				...
				endPillarId + "-" + startPillarId + "-" + POINT_TYPE[9]) ) {
				MeasPoint rightOutPoint = new MeasPoint();
				rightOutPoint.setPointId(POINT_TYPE[1] + "-" + POINT_TYPE[4] + "-" + endPillarId + "-" + startPillarId + "-" +  POINT_TYPE[9]);
				rightOutPoint.setPointX(Double.parseDouble(rowData[1]));
				rightOutPoint.setPointY(Double.parseDouble(rowData[2]));
				rightOutPoint.setPointZ(Double.parseDouble(rowData[3]));
				rightOutPoint.setPointType(POINT_TYPE[1] + "-" + POINT_TYPE[4] + "-" + POINT_TYPE[9]);
			...
			else if( rowData[0].equalsIgnoreCase(POINT_TYPE[3] + "-" + endPillarId + "-" + startPillarId + "-"  + POINT_TYPE[9]) ) {
				MeasPoint mediumUppestPoint = new MeasPoint();
				mediumUppestPoint.setPointId(POINT_TYPE[3] + "-" + endPillarId + "-" + startPillarId + "-"  +  POINT_TYPE[9]);
				mediumUppestPoint.setPointX(Double.parseDouble(rowData[1]));
				mediumUppestPoint.setPointY(Double.parseDouble(rowData[2]));
				mediumUppestPoint.setPointZ(Double.parseDouble(rowData[3]));
				mediumUppestPoint.setPointType(POINT_TYPE[3] + "-" + POINT_TYPE[9]);
	...
	double leftUppestMinValue = leftTheUppestWirePointList.stream().mapToDouble( e -> e.pointZ).min().orElse(0d);
	if( leftUppestMinValue != 0 ) {
		minValueList.add(leftUppestMinValue);
	}
	double mediumUppestMinValue = mediumTheUppestWirePointList.stream().mapToDouble( e -> e.pointZ).min().orElse(0d);
	if( mediumUppestMinValue != 0 ) {
		minValueList.add(mediumUppestMinValue);
	}
	double rightUppestMinValue = rightTheUppestWirePointList.stream().mapToDouble( e -> e.pointZ).min().orElse(0d);
	if( rightUppestMinValue != 0 ) {
		minValueList.add(rightUppestMinValue);
	}
	...
	if( rightOutsideMinValue != 0 ) {
		minValueList.add(rightOutsideMinValue);	
	}
	double leftMediumMinValue = leftMediumWirePointList.stream().mapToDouble( e -> e.pointZ).min().orElse(0d);
	if( leftMediumMinValue != 0 ) {
		minValueList.add(leftMediumMinValue);	
	}
	double rightMediumMinValue = rightMediumWirePointList.stream().mapToDouble( e -> e.pointZ).min().orElse(0d);
	if( rightMediumMinValue != 0 ) {
		minValueList.add(rightMediumMinValue);	
	}
	...
	public int getMaxElevation() {
		...
		double leftUppestMaxValue = leftTheUppestWirePointList.stream().mapToDouble( e -> e.pointZ).max().orElse(0d);
		if( leftUppestMaxValue != 0 ) {
			maxValueList.add(leftUppestMaxValue);
		}
		double mediumUppestMaxValue = mediumTheUppestWirePointList.stream().mapToDouble( e -> e.pointZ).max().orElse(0d);
		if( mediumUppestMaxValue != 0 ) {
			maxValueList.add(mediumUppestMaxValue);
		}
		double rightUppestMaxValue = rightTheUppestWirePointList.stream().mapToDouble( e -> e.pointZ).max().orElse(0d);
		if( rightUppestMaxValue != 0 ) {
			maxValueList.add(rightUppestMaxValue);
		}
		...
		double leftMediumMaxValue = leftMediumWirePointList.stream().mapToDouble( e -> e.pointZ).max().orElse(0d);
		if( rightInsideMaxValue != 0 ) {
			maxValueList.add(leftMediumMaxValue);	
		}
		double rightMediumMaxValue = rightMediumWirePointList.stream().mapToDouble( e -> e.pointZ).max().orElse(0d);
		if( rightInsideMaxValue != 0 ) {
			maxValueList.add(rightMediumMaxValue);	
		}
	...
	private List<MeasPoint> getStartPillarLeftMeasPointList() {	
		MeasPoint startUpPoint = getStartPillarPointById(POINT_TYPE[0] + "-" + startPillarId + "-" + POINT_TYPE[9], true);
		if( startUpPoint == null ){
			startUpPoint = getStartPillarPointById(POINT_TYPE[0] + "-" + startPillarId + "-" + endPillarId + "-" + POINT_TYPE[9], true);
		}
		MeasPoint startDownPoint = getStartPillarPointById(POINT_TYPE[0] + "-" + startPillarId + "-" + POINT_TYPE[9], false);
	...
	private List<MeasPoint> getEndPillarLeftMeasPointList() {	
		MeasPoint endUpPoint = getEndPillarPointById(POINT_TYPE[0] + "-" + endPillarId + "-" + POINT_TYPE[9], true);
		if( endUpPoint == null ) {
			endUpPoint = getEndPillarPointById(POINT_TYPE[0] + "-" + endPillarId + "-" + startPillarId + "-" + POINT_TYPE[9], true);
		}
	...
	private List<MeasPoint> getStartPillarRightMeasPointList() {	
		MeasPoint startUpPoint = getStartPillarPointById(POINT_TYPE[1] + "-" + startPillarId + "-" + POINT_TYPE[9], true);
		if( startUpPoint == null ) {
			startUpPoint = getStartPillarPointById(POINT_TYPE[1] + "-" + startPillarId + "-" + endPillarId + "-" + POINT_TYPE[9], true);
		}
		MeasPoint startDownPoint = getStartPillarPointById(POINT_TYPE[1] + "-" + startPillarId + "-" + POINT_TYPE[9], false);
		if( startDownPoint == null ) {
	...
	private List<MeasPoint> getEndPillarRightMeasPointList() {	
		MeasPoint endUpPoint = getEndPillarPointById(POINT_TYPE[1] + "-" + endPillarId + "-" + POINT_TYPE[9], true);
		if( endUpPoint == null ){
			endUpPoint = getEndPillarPointById(POINT_TYPE[1] + "-" + endPillarId + "-" + startPillarId + "-" + POINT_TYPE[9], true);
		}
	...
	private List<MeasPoint> getStartPillarLeftOutsideMeasPointList() {	
		MeasPoint startUpPoint = getStartPillarPointById(POINT_TYPE[0] + "-" + POINT_TYPE[4] + "-" + startPillarId + "-" + POINT_TYPE[9], true);
		if( startUpPoint == null ) {
			startUpPoint = getStartPillarPointById(POINT_TYPE[0] + "-" + POINT_TYPE[4] + "-" + 
		startPillarId + "-" + endPillarId + "-" + POINT_TYPE[9], true);
		}
		MeasPoint startDownPoint = getStartPillarPointById(POINT_TYPE[0] + "-" + POINT_TYPE[4] + "-" + startPillarId + "-" + POINT_TYPE[9], false);
		if( startDownPoint == null ) {
	...
	private List<MeasPoint> getEndPillarLeftOutsideMeasPointList() {	
		MeasPoint endUpPoint = getEndPillarPointById(POINT_TYPE[0] + "-" + POINT_TYPE[4] + "-" + endPillarId + "-" + POINT_TYPE[9], true);
		if( endUpPoint == null ) {
			endUpPoint = getEndPillarPointById(POINT_TYPE[0] + "-" + POINT_TYPE[4] + "-" +
					endPillarId + "-" + startPillarId + "-" + POINT_TYPE[9], true);
		}
		MeasPoint endDownPoint = getEndPillarPointById(POINT_TYPE[0] + "-" + POINT_TYPE[4] + "-" + endPillarId + "-" + POINT_TYPE[9], false);
		if( endDownPoint == null ) {
	...
	private List<MeasPoint> getStartPillarLeftInsideMeasPointList() {
		MeasPoint startUpPoint = getStartPillarPointById(POINT_TYPE[0] + "-" + POINT_TYPE[5] + "-" + startPillarId + "-" + POINT_TYPE[9], true);
		if( startUpPoint == null ) {
			startUpPoint = getStartPillarPointById(POINT_TYPE[0] + "-" + POINT_TYPE[5] + "-" + 
		startPillarId + "-" + endPillarId + "-" + POINT_TYPE[9], true);
		}
		MeasPoint startDownPoint = getStartPillarPointById(POINT_TYPE[0] + "-" + POINT_TYPE[5] + "-" + startPillarId + "-" + POINT_TYPE[9], false);
		if( startDownPoint == null ) {
	...
	private List<MeasPoint> getEndPillarLeftInsideMeasPointList() {
		MeasPoint endUpPoint = getEndPillarPointById(POINT_TYPE[0] + "-" + POINT_TYPE[5] + "-" + endPillarId + "-" + POINT_TYPE[9], true);
		if( endUpPoint == null ) {
			endUpPoint = getEndPillarPointById(POINT_TYPE[0] + "-" + POINT_TYPE[5] + "-" +
		endPillarId + "-" + startPillarId + "-" + POINT_TYPE[9], true);
		}
		MeasPoint endDownPoint = getEndPillarPointById(POINT_TYPE[0] + "-" + POINT_TYPE[5] + "-" + endPillarId + "-" + POINT_TYPE[9], false);
		if( endDownPoint == null ) {
   ...
   private List<MeasPoint> getStartPillarLeftTheUppestMeasPointList() {
	   MeasPoint startUpPoint = getStartPillarPointById(POINT_TYPE[0] + "-" + POINT_TYPE[3] + "-" + startPillarId + "-" + POINT_TYPE[9], true);
	   if( startUpPoint == null ) {
		   startUpPoint = getStartPillarPointById(POINT_TYPE[0] + "-" + POINT_TYPE[3] + "-" + startPillarId + "-" + endPillarId + "-" + POINT_TYPE[9], true);
	   }
	   MeasPoint startDownPoint = getStartPillarPointById(POINT_TYPE[0] + "-" + POINT_TYPE[3] + "-" + startPillarId + "-" + POINT_TYPE[9], false);
	   if( startDownPoint == null ) {
   ...
   private List<MeasPoint> getStartPillarLeftMediumMeasPointList() {
	   MeasPoint startUpPoint = getStartPillarPointById(POINT_TYPE[0] + "-" + POINT_TYPE[2] + "-" + startPillarId + "-" + POINT_TYPE[9], true);
	   if( startUpPoint == null ) {
		   startUpPoint = getStartPillarPointById(POINT_TYPE[0] + "-" + POINT_TYPE[2] + "-" + startPillarId + "-" + endPillarId + "-" + POINT_TYPE[9], true);
	   }
   ...
   private List<MeasPoint> getStartPillarRightMediumMeasPointList() {
	   MeasPoint startUpPoint = getStartPillarPointById(POINT_TYPE[1] + "-" + POINT_TYPE[2] + "-" + startPillarId + "-" + POINT_TYPE[9], true);
	   if( startUpPoint == null ) {
		   startUpPoint = getStartPillarPointById(POINT_TYPE[1] + "-" + POINT_TYPE[2] + "-" + startPillarId + "-" + endPillarId + "-" + POINT_TYPE[9], true);
	   }
	   MeasPoint startDownPoint = getStartPillarPointById(POINT_TYPE[1] + "-" + POINT_TYPE[2] + "-" + startPillarId + "-" + POINT_TYPE[9], false);
	   if( startDownPoint == null ) {
   ...
   private List<MeasPoint> getEndPillarLeftTheUppestMeasPointList() {
	   MeasPoint startUpPoint = getEndPillarPointById(POINT_TYPE[0] + "-" + POINT_TYPE[3] + "-" + endPillarId + "-" + POINT_TYPE[9], true);
	   if( startUpPoint == null ) {
		   startUpPoint = getEndPillarPointById(POINT_TYPE[0] + "-" + POINT_TYPE[3] + "-" + endPillarId + "-" + startPillarId + "-" + POINT_TYPE[9], true);
	   }
   ...
   private List<MeasPoint> getStartPillarMediumTheUppestMeasPointList() {
	   MeasPoint startUpPoint = getStartPillarPointById(POINT_TYPE[3] + "-" + startPillarId + "-" + POINT_TYPE[9], true);
	   if( startUpPoint == null ) {
		   startUpPoint = getStartPillarPointById(POINT_TYPE[3] + "-" + startPillarId + "-" + endPillarId + "-" + POINT_TYPE[9], true);
	   }
	   MeasPoint startDownPoint = getStartPillarPointById(POINT_TYPE[3] + "-" + startPillarId + "-" + POINT_TYPE[9], false);
	   if( startDownPoint == null ) {
   ...
   private List<MeasPoint> getEndPillarMediumTheUppestMeasPointList() {
	   MeasPoint startUpPoint = getEndPillarPointById(POINT_TYPE[3] + "-" + endPillarId + "-" + POINT_TYPE[9], true);
	   if( startUpPoint == null ) {
		   startUpPoint = getEndPillarPointById(POINT_TYPE[3] + "-" + endPillarId + "-" + startPillarId + "-" + POINT_TYPE[9], true);
	   }
   ...
   private List<MeasPoint> getStartPillarRightTheUppestMeasPointList() {
	   MeasPoint startUpPoint = getStartPillarPointById(POINT_TYPE[1] + "-" + POINT_TYPE[3] + "-" + startPillarId + "-" + POINT_TYPE[9], true);
	   if( startUpPoint == null ) {
		   startUpPoint = getStartPillarPointById(POINT_TYPE[1] + "-" + POINT_TYPE[3] + "-" + startPillarId + "-" + endPillarId + "-" + POINT_TYPE[9], true);
	   }
	   MeasPoint startDownPoint = getStartPillarPointById(POINT_TYPE[1] + "-" + POINT_TYPE[3] + "-" + startPillarId + "-" + POINT_TYPE[9], false);
	   if( startDownPoint == null ) {
   ...
   private List<MeasPoint> getEndPillarRightTheUppestMeasPointList() {
	   MeasPoint startUpPoint = getEndPillarPointById(POINT_TYPE[1] + "-" + POINT_TYPE[3] + "-" + endPillarId + "-" + POINT_TYPE[9], true);
	   if( startUpPoint == null ) {
		   startUpPoint = getEndPillarPointById(POINT_TYPE[1] + "-" + POINT_TYPE[3] + "-" + endPillarId + "-" + startPillarId + "-" + POINT_TYPE[9], true);
	   }
   ...
   private List<MeasPoint> getEndPillarLeftMediumMeasPointList() {
	   MeasPoint startUpPoint = getEndPillarPointById(POINT_TYPE[0] + "-" + POINT_TYPE[2] + "-" + endPillarId + "-" + POINT_TYPE[9], true);
	   if( startUpPoint == null ) {
		   startUpPoint = getEndPillarPointById(POINT_TYPE[0] + "-" + POINT_TYPE[2] + "-" + endPillarId + "-" + startPillarId + "-" + POINT_TYPE[9], true);
	   }
	   MeasPoint startDownPoint = getEndPillarPointById(POINT_TYPE[0] + "-" + POINT_TYPE[2] + "-" + endPillarId + "-" + POINT_TYPE[9], false);
	   if( startDownPoint == null ) {
   ...
   private List<MeasPoint> getEndPillarRightMediumMeasPointList() {
	   MeasPoint startUpPoint = getEndPillarPointById(POINT_TYPE[1] + "-" + POINT_TYPE[2] + "-" + endPillarId + "-" + POINT_TYPE[9], true);
	   if( startUpPoint == null ) {
		   startUpPoint = getEndPillarPointById(POINT_TYPE[1] + "-" + POINT_TYPE[2] + "-" + endPillarId + "-" + startPillarId + "-" + POINT_TYPE[9], true);
	   }
   ...
   private List<MeasPoint> getStartPillarMediumMeasPointList() {
	   MeasPoint startUpPoint = getStartPillarPointById(POINT_TYPE[2] + "-" + startPillarId + "-" + POINT_TYPE[9], true);
	   if( startUpPoint == null ) {
		   startUpPoint = getStartPillarPointById(POINT_TYPE[2] + "-" + startPillarId + "-" + endPillarId + "-" + POINT_TYPE[9], true);
	   }
	   MeasPoint startDownPoint = getStartPillarPointById(POINT_TYPE[2] + "-" + startPillarId + "-" + POINT_TYPE[9], false);
	   if( startDownPoint == null ) {
   ...
   private List<MeasPoint> getEndPillarMediumMeasPointList() {
	   MeasPoint endUpPoint = getEndPillarPointById(POINT_TYPE[2] + "-" + endPillarId + "-" + POINT_TYPE[9], true);
	   if( endUpPoint == null ) {
		   endUpPoint = getEndPillarPointById(POINT_TYPE[2] + "-" + endPillarId + "-" + startPillarId + "-" + POINT_TYPE[9], true);
	   }
	...
	private List<MeasPoint> getStartPillarRightInsideMeasPointList() {
		 MeasPoint startUpPoint = getStartPillarPointById(POINT_TYPE[1] + "-" + POINT_TYPE[5] + "-" + startPillarId + "-" + POINT_TYPE[9], true);
		 if( startUpPoint == null ) {
			 startUpPoint = getStartPillarPointById(POINT_TYPE[1] + "-" + POINT_TYPE[5] + "-" + 
		 startPillarId + "-" + endPillarId + "-" + POINT_TYPE[9], true);
		 }
		 MeasPoint startDownPoint = getStartPillarPointById(POINT_TYPE[1] + "-" + POINT_TYPE[5] + "-" + startPillarId + "-" + POINT_TYPE[9], false);
		 if( startDownPoint == null ) {
	...
	private List<MeasPoint> getEndPillarRightInsideMeasPointList() {
		 MeasPoint endUpPoint = getEndPillarPointById(POINT_TYPE[1] + "-" + POINT_TYPE[5] + "-" + endPillarId + "-" + POINT_TYPE[9], true);
		 if( endUpPoint == null ) {
			 endUpPoint = getEndPillarPointById(POINT_TYPE[1] + "-" + POINT_TYPE[5] + "-" + 
		 endPillarId + "-" + startPillarId + "-" + POINT_TYPE[9], true);
		 }
		 MeasPoint endDownPoint = getEndPillarPointById(POINT_TYPE[1] + "-" + POINT_TYPE[5] + "-" + endPillarId + "-" + POINT_TYPE[9], false);
		 if( endDownPoint == null ) {
   ...
   private List<MeasPoint> getStartPillarRightOutsideMeasPointList() {
	   	 MeasPoint startUpPoint = getStartPillarPointById(POINT_TYPE[1] + "-" + POINT_TYPE[4] + "-" + startPillarId + "-" + POINT_TYPE[9], true);
	   	 if( startUpPoint == null ) {
	   		 startUpPoint = getStartPillarPointById(POINT_TYPE[1] + "-" + POINT_TYPE[4] + "-" + 
	   	 startPillarId + "-" + endPillarId + "-" + POINT_TYPE[9], true);
	   	 }
	   	MeasPoint startDownPoint = getStartPillarPointById(POINT_TYPE[1] + "-" + POINT_TYPE[4] + "-" + startPillarId + "-" + POINT_TYPE[9], false);
	   	 if( startDownPoint == null ) {
   ...
   private List<MeasPoint> getEndPillarRightOutsideMeasPointList() {
	   MeasPoint endUpPoint = getEndPillarPointById(POINT_TYPE[1] + "-" + POINT_TYPE[4] + "-" + endPillarId + "-" + POINT_TYPE[9], true);
		 if( endUpPoint == null ) {
			 endUpPoint = getEndPillarPointById(POINT_TYPE[1] + "-" + POINT_TYPE[4] + "-" +
		 endPillarId + "-" + startPillarId + "-" + POINT_TYPE[9], true);
		 }
		 MeasPoint endDownPoint = getEndPillarPointById(POINT_TYPE[1] + "-" + POINT_TYPE[4] + "-" + endPillarId + "-" + POINT_TYPE[9], false);
		 if( endDownPoint == null ) {
 ...
 public List<MeasPoint> getStartPillarMeasPointList(){
	   ...
	   for (MeasPoint measPoint : getStartPillarLeftTheUppestMeasPointList()) {
		   if( measPoint != null ) {
			   measPointList.add(measPoint);
		   }
	   }
	   for (MeasPoint measPoint : getStartPillarMediumTheUppestMeasPointList()) {
			if( measPoint != null ) {
				measPointList.add(measPoint);
			   }
		}
	   for (MeasPoint measPoint : getStartPillarRightTheUppestMeasPointList()) {
			if( measPoint != null ) {
				measPointList.add(measPoint);
				   }
			   }
	   for (MeasPoint measPoint : getStartPillarLeftMediumMeasPointList()) {
			if( measPoint != null ) {
				measPointList.add(measPoint);
				   }
			   }
	   for (MeasPoint measPoint : getStartPillarRightMediumMeasPointList()) {
			if( measPoint != null ) {
				measPointList.add(measPoint);
				   }
			   }
   ...
   private List<MeasPoint> getStartPillarBaseTopData(){
	   ...
	   double startTopX = startPillarPointList.stream()
				.filter(a -> a.pointType.equals(POINT_TYPE[7]))
				.mapToDouble(a -> a.pointX)
				.average().orElse(0d);
	   ...
	   double startTopZ = startPillarPointList.stream()
					.filter(b -> b.pointType.equals(POINT_TYPE[7]))
					.mapToDouble(b -> b.pointZ).average().orElse(0d);
 ...
 public List<MeasPoint> getEndPillarMeasPointList(){
	   ...
	   for (MeasPoint measPoint : getEndPillarLeftTheUppestMeasPointList()) {
		   if( measPoint != null ) {
			   measPointList.add(measPoint);
		   }
	   }
		for (MeasPoint measPoint : getEndPillarMediumTheUppestMeasPointList()) {
			if( measPoint != null ) {
				measPointList.add(measPoint);
			}
		}
		for (MeasPoint measPoint : getEndPillarRightTheUppestMeasPointList()) {
			if( measPoint != null ) {
				measPointList.add(measPoint);
			}
		}
		for (MeasPoint measPoint : getEndPillarLeftMediumMeasPointList()) {
			if( measPoint != null ) {
				measPointList.add(measPoint);
			}
		}
		for (MeasPoint measPoint : getEndPillarRightMediumMeasPointList()) {
			if( measPoint != null ) {
				measPointList.add(measPoint);
			}
		}
 ...
 public List<Double> getLengthOfSectionBetweenPillars(){
	 ...
	 List<MeasPoint> leftUppestStart = getStartPillarLeftTheUppestMeasPointList();
	 List<MeasPoint> leftUppestEnd = getEndPillarLeftTheUppestMeasPointList();
	 List<MeasPoint> mediumUppestStart = getStartPillarMediumTheUppestMeasPointList();
	 List<MeasPoint> mediumUppestEnd = getEndPillarMediumTheUppestMeasPointList();
	 List<MeasPoint> rightUppestStart = getStartPillarRightTheUppestMeasPointList();
	 List<MeasPoint> rightUppestEnd = getEndPillarRightTheUppestMeasPointList();
	 List<MeasPoint> leftMediumStart = getStartPillarLeftMediumMeasPointList();
	 List<MeasPoint> leftMediumEnd = getEndPillarLeftMediumMeasPointList();
	 List<MeasPoint> rightMediumStart = getStartPillarRightMediumMeasPointList();
	 List<MeasPoint> rightMediumEnd = getEndPillarRightMediumMeasPointList();
	 ...
	 return Arrays.asList(calcHorizonatlDistance(leftStart.get(1), leftEnd.get(1)),
			  ...
			  calcHorizonatlDistance(leftUppestStart.get(1), leftUppestEnd.get(1)),
			  calcHorizonatlDistance(mediumUppestStart.get(1), mediumUppestEnd.get(1)),
			  calcHorizonatlDistance(rightUppestStart.get(1), rightUppestEnd.get(1)),
			  calcHorizonatlDistance(leftMediumStart.get(1), leftMediumEnd.get(1)),
			  calcHorizonatlDistance(rightMediumStart.get(1), rightMediumEnd.get(1)));
 }
 ...
 public List<MeasWire> getMeasWirePointList(){
	 ...
	 if( !leftTheUppestWirePointList.isEmpty() ) {
		 HashSet<String> idSet = getWireIdSet(leftTheUppestWirePointList);
		 measWire.addAll(parseMeasWireData(idSet, 7));
	 	}
	 if( !mediumTheUppestWirePointList.isEmpty() ) {
		 HashSet<String> idSet = getWireIdSet(mediumTheUppestWirePointList);
		 measWire.addAll(parseMeasWireData(idSet, 8));
	 	}
	 if( !rightTheUppestWirePointList.isEmpty() ) {
		 HashSet<String> idSet = getWireIdSet(rightTheUppestWirePointList);
		 measWire.addAll(parseMeasWireData(idSet, 9));
	 	}
	 if( !leftMediumWirePointList.isEmpty() ) {
		 HashSet<String> idSet = getWireIdSet(leftMediumWirePointList);
		 measWire.addAll(parseMeasWireData(idSet, 10));
	 	}
	 if( !rightMediumWirePointList.isEmpty() ) {
		 HashSet<String> idSet = getWireIdSet(rightMediumWirePointList);
		 measWire.addAll(parseMeasWireData(idSet, 11));
	 	}
 ...
 private HashSet<String> getWireIdSet(List<MeasPoint> wirePointList){
	 ...
	 for (MeasPoint wirePoint : wirePointList) {
		 ...
		 String[] idComponents = wirePoint.pointId.split("-");
		 	...
		 	else if( idComponents.length == 5 && wirePoint.pointId.toUpperCase().endsWith(POINT_TYPE[10]) ) { 
				 	idSet.add(idComponents[3]);
			}
			else  if( idComponents.length == 5 && startPillarId.equals(idComponents[1]) && 
					!wirePoint.pointId.toUpperCase().endsWith(POINT_TYPE[10]) && 
					!wirePoint.pointId.toUpperCase().endsWith(POINT_TYPE[11]) ) { 
			...
			else if( idComponents.length == 5 && wirePoint.pointId.toUpperCase().endsWith(POINT_TYPE[11]) ) { 
					idSet.add(idComponents[3]);
				}
		 	
			else if( idComponents.length == 6 && startPillarId.equals(idComponents[1]) && wirePoint.pointId.toUpperCase().endsWith(POINT_TYPE[10]) ) { 
					idSet.add(idComponents[3] + "-" +idComponents[4]);
			}
			else if( idComponents.length == 6 && startPillarId.equals(idComponents[2]) && wirePoint.pointId.toUpperCase().endsWith(POINT_TYPE[10]) ) { 
				idSet.add(idComponents[4]);
			}
			else  if( idComponents.length == 6 && 
					!wirePoint.pointId.toUpperCase().endsWith(POINT_TYPE[10]) &&
					!wirePoint.pointId.toUpperCase().endsWith(POINT_TYPE[11]) ) { 
				
					idSet.add(idComponents[4] + "-" + idComponents[5]);
				}
			else if( idComponents.length == 6 && startPillarId.equals(idComponents[1]) && wirePoint.pointId.toUpperCase().endsWith(POINT_TYPE[11]) ) { 
					idSet.add(idComponents[3] + "-" +idComponents[4]);
		}
			else if( idComponents.length == 6 && startPillarId.equals(idComponents[2]) && wirePoint.pointId.toUpperCase().endsWith(POINT_TYPE[11]) ) { 
					idSet.add(idComponents[4]);
		}
			else if( idComponents.length == 7 ) {
					idSet.add(idComponents[4] + "-" + idComponents[5]);
			}			
	 }
 ...
 private List<MeasWire> parseMeasWireData(HashSet<String> wireIdSet, int wireDataType){
	 ...
	 if (wireDataType == 0) {
		...
		for (String wireId : wireIdSet) {
			...
			for (MeasPoint measPoint : leftOutsideWirePointList){
			 ...
			 else if( measPoint.pointId.equals(POINT_TYPE[0] + "-" + startPillarId + "-" + endPillarId + "-" +  wireId + "-" + POINT_TYPE[11]) ) {
			...
			if( measWire.getGroundPoint() == null ) {
				measWire.setWireId(POINT_TYPE[0] + "-" + startPillarId + "-" + endPillarId + "-" + POINT_TYPE[8]);
	...
	for (String wireId : wireIdSet) {
		...
		for (MeasPoint measPoint : mediumWirePointList){
		 ...
		 else if( measPoint.pointId.equals(POINT_TYPE[2] + "-" + startPillarId + "-" + endPillarId + "-" +  wireId + "-" + POINT_TYPE[11]) ) {
			 measWire.setSDRPoint(measPoint);
		 }
		...
		if( measWire.getGroundPoint() == null ) {
			measWire.setWireId(POINT_TYPE[2] + "-" + startPillarId + "-" + endPillarId + "-" + POINT_TYPE[8]);
		...
		if( measWire.getSDRPoint() != null ) {
			...
			for (String wireId : wireIdSet) {
				...
				for (MeasPoint measPoint : rightOutsideWirePointList){
				 ...
				 else if( measPoint.pointId.equals(POINT_TYPE[1] + "-" + startPillarId + "-" + endPillarId + "-" +  wireId + "-" + POINT_TYPE[11]) ) {
					 measWire.setSDRPoint(measPoint);
				 }
				...
				if( measWire.getGroundPoint() == null ) {
					measWire.setWireId(POINT_TYPE[1] + "-" + startPillarId + "-" + endPillarId + "-" + POINT_TYPE[8]);
			...
			for (String wireId : wireIdSet) {
				...
				if( measWire.getGroundPoint() == null ) {
					measWire.setWireId(POINT_TYPE[0] + "-" + POINT_TYPE[4] + "-" + startPillarId + "-" + endPillarId + "-" + POINT_TYPE[8]);
			...
			for (String wireId : wireIdSet) {
				...
				for (MeasPoint measPoint : leftInsideWirePointList){
				 ...
				 if( measPoint.pointId.equals(POINT_TYPE[0] + "-" + POINT_TYPE[5] + "-" + startPillarId + "-" + endPillarId + "-" +  wireId) && 
						 !measPoint.isUpper ) {
					 measWire.setGroundPoint(measPoint);
				 }
				 else if( measPoint.pointId.equals(POINT_TYPE[0] + "-" + POINT_TYPE[5] + "-" + startPillarId + "-" + endPillarId + "-" +  wireId
						 + "-" + POINT_TYPE[10]) ) {
					 measWire.setVEZPoint(measPoint);
				 }
				 else if( measPoint.pointId.equals(POINT_TYPE[0] + "-" + POINT_TYPE[5] + "-" + startPillarId + "-" + endPillarId + "-" +  wireId
				...
				if( measWire.getGroundPoint() == null ) {
					measWire.setWireId(POINT_TYPE[0] + "-" + POINT_TYPE[5]  + "-" + startPillarId + "-" + endPillarId + "-" + POINT_TYPE[8]);
	...
	for (String wireId : wireIdSet) {
		...
		for (MeasPoint measPoint : rightInsideWirePointList){
		 ...
		 if( measPoint.pointId.equals(POINT_TYPE[1] + "-" + POINT_TYPE[5] + "-" + startPillarId + "-" + endPillarId + "-" +  wireId) && 
				 !measPoint.isUpper ) {
			 measWire.setGroundPoint(measPoint);
		 }
		 else if( measPoint.pointId.equals(POINT_TYPE[1] + "-" + POINT_TYPE[5] + "-" + startPillarId + "-" + endPillarId + "-" +  wireId
				 + "-" + POINT_TYPE[10]) ) {
			 measWire.setVEZPoint(measPoint);
		 }
		 else if( measPoint.pointId.equals(POINT_TYPE[1] + "-" + POINT_TYPE[5] + "-" + startPillarId + "-" + endPillarId + "-" +  wireId
		...
		if( measWire.getGroundPoint() == null ) {
			measWire.setWireId(POINT_TYPE[1] + "-" + POINT_TYPE[5]  + "-" + startPillarId + "-" + endPillarId + "-" + POINT_TYPE[8]);
		...
		for (String wireId : wireIdSet) {
			...
			if( measWire.getGroundPoint() == null ) {
				measWire.setWireId(POINT_TYPE[1] + "-" + POINT_TYPE[4]  + "-" + startPillarId + "-" + endPillarId + "-" + POINT_TYPE[8]);
	...
	else if (wireDataType == 7) {
	
		for (String wireId : wireIdSet) {
			MeasWire measWire = new MeasWire();
			measWire.setWireType(wireDataType);
			measWire.setWireId(wireId);
			for (MeasPoint measPoint : leftTheUppestWirePointList){
			 ...
			 if( measPoint.pointId.equals(POINT_TYPE[0] + "-" + POINT_TYPE[3] + "-" + startPillarId + "-" + endPillarId + "-" +  wireId) && 
				 ...
				 measWire.setVEZPoint(measPoint);
					 ...
					 + "-" + POINT_TYPE[11]) && 
					 measPoint.pointId.endsWith(POINT_TYPE[11]) ) {
				 measWire.setSDRPoint(measPoint);
			 }
			 else if( measPoint.pointId.equals(POINT_TYPE[0] + "-" + POINT_TYPE[3] + "-" + startPillarId + "-" + endPillarId + "-" +  wireId) && 
					 measPoint.isUpper ) {
			...
			MeasPoint grabPoint = getStartPillarLeftTheUppestMeasPointList().get(1);
			if( grabPoint != null ) {
			measWire.setDistanceOfWire(grabPoint);
			}
			if( measWire.getGroundPoint() == null ) {
				measWire.setWireId(POINT_TYPE[0] + "-" + POINT_TYPE[3]  + "-" + startPillarId + "-" + endPillarId + "-" + POINT_TYPE[8]);
				measWire.calcHalfPillarSectionGroundPoint(getStartPillarLeftTheUppestMeasPointList().get(0), 
						getEndPillarLeftTheUppestMeasPointList().get(0));
			}
			if( measWire.getSDRPoint() != null ) {
				measWireList.add(measWire);
			}
		...
		for (String wireId : wireIdSet) {
			...
			measWire.setWireType(wireDataType);
			measWire.setWireId(wireId);
			for (MeasPoint measPoint : mediumTheUppestWirePointList){
				
			 if( measPoint.pointId.equals(POINT_TYPE[3] + "-" + startPillarId + "-" + endPillarId + "-" +  wireId) && 
					 !measPoint.isUpper ) {
				 measWire.setGroundPoint(measPoint);
			 }
			 else if( measPoint.pointId.equals(POINT_TYPE[3] + "-" + startPillarId + "-" + endPillarId + "-" +  wireId
					 + "-" + POINT_TYPE[10]) && 
					 measPoint.pointId.endsWith(POINT_TYPE[10]) ) {
				 measWire.setVEZPoint(measPoint);
			 }
			...
			MeasPoint grabPoint = getStartPillarMediumTheUppestMeasPointList().get(1);
			if( grabPoint != null ) {
			measWire.setDistanceOfWire(grabPoint);
			}
			if( measWire.getGroundPoint() == null ) {
				measWire.setWireId(POINT_TYPE[3]  + "-" + startPillarId + "-" + endPillarId + "-" + POINT_TYPE[8]);
				measWire.calcHalfPillarSectionGroundPoint(getStartPillarMediumTheUppestMeasPointList().get(0), 
						getEndPillarMediumTheUppestMeasPointList().get(0));
			}
			if( measWire.getSDRPoint() != null ) {
				measWireList.add(measWire);
			}
	...
	else if (wireDataType == 9) {
		for (String wireId : wireIdSet) {
			MeasWire measWire = new MeasWire();
			measWire.setWireType(wireDataType);
			measWire.setWireId(wireId);
			for (MeasPoint measPoint : rightTheUppestWirePointList){
			...
			MeasPoint grabPoint = getStartPillarRightTheUppestMeasPointList().get(1);
			if( grabPoint != null ) {
			measWire.setDistanceOfWire(grabPoint);
			}
			if( measWire.getGroundPoint() == null ) {
				measWire.setWireId(POINT_TYPE[1] + "-" + POINT_TYPE[3]  + "-" + startPillarId + "-" + endPillarId + "-" + POINT_TYPE[8]);
				measWire.calcHalfPillarSectionGroundPoint(getStartPillarRightTheUppestMeasPointList().get(0), 
						getEndPillarRightTheUppestMeasPointList().get(0));
			}
			if( measWire.getSDRPoint() != null ) {
				measWireList.add(measWire);
			}
	...
	else if (wireDataType == 10) {
		for (String wireId : wireIdSet) {
			MeasWire measWire = new MeasWire();
			measWire.setWireType(wireDataType);
			measWire.setWireId(wireId);
			for (MeasPoint measPoint : leftMediumWirePointList){
			
			 if( measPoint.pointId.equals(POINT_TYPE[0] + "-" + POINT_TYPE[2] + "-" + startPillarId + "-" + endPillarId + "-" +  wireId) && 
					 !measPoint.isUpper ) {
				 measWire.setGroundPoint(measPoint);
			 }
			 else if( measPoint.pointId.equals(POINT_TYPE[0] + "-" + POINT_TYPE[2] + "-" + startPillarId + "-" + endPillarId + "-" +  wireId
					 + "-" + POINT_TYPE[10]) && 
					 measPoint.pointId.endsWith(POINT_TYPE[10]) ) {
				 measWire.setVEZPoint(measPoint);
			 }
			...
			MeasPoint grabPoint = getStartPillarLeftMediumMeasPointList().get(1);
			if( grabPoint != null ) {
			measWire.setDistanceOfWire(grabPoint);
			}
			if( measWire.getGroundPoint() == null ) {
				measWire.setWireId(POINT_TYPE[0] + "-" + POINT_TYPE[2]  + "-" + startPillarId + "-" + endPillarId + "-" + POINT_TYPE[8]);
				measWire.calcHalfPillarSectionGroundPoint(getStartPillarLeftMediumMeasPointList().get(0), 
						getEndPillarLeftMediumMeasPointList().get(0));
			}
			if( measWire.getSDRPoint() != null ) {
				measWireList.add(measWire);
			}
	...
	else if (wireDataType == 11) {
		for (String wireId : wireIdSet) {
			MeasWire measWire = new MeasWire();
			measWire.setWireType(wireDataType);
			measWire.setWireId(wireId);
			for (MeasPoint measPoint : rightMediumWirePointList){
			
			 if( measPoint.pointId.equals(POINT_TYPE[1] + "-" + POINT_TYPE[2] + "-" + startPillarId + "-" + endPillarId + "-" +  wireId) && 
					 !measPoint.isUpper ) {
				 measWire.setGroundPoint(measPoint);
			 }
			 else if( measPoint.pointId.equals(POINT_TYPE[1] + "-" + POINT_TYPE[2] + "-" + startPillarId + "-" + endPillarId + "-" +  wireId
					 + "-" + POINT_TYPE[10]) && 
					 measPoint.pointId.endsWith(POINT_TYPE[10]) ) {
				 measWire.setVEZPoint(measPoint);
			 }
			...
			MeasPoint grabPoint = getStartPillarRightMediumMeasPointList().get(1);
			if( grabPoint != null ) {
			measWire.setDistanceOfWire(grabPoint);
			}
			if( measWire.getGroundPoint() == null ) {
				measWire.setWireId(POINT_TYPE[1] + "-" + POINT_TYPE[2]  + "-" + startPillarId + "-" + endPillarId + "-" + POINT_TYPE[8]);
				measWire.calcHalfPillarSectionGroundPoint(getStartPillarRightMediumMeasPointList().get(0), 
						getEndPillarRightMediumMeasPointList().get(0));
			}
			if( measWire.getSDRPoint() != null ) {
				measWireList.add(measWire);
			}
 ...
 public List<MeasPoint> getMeasGroundPointList(){
	 ...
	 for (String measDataRow : measDataList) {
		...
		if( rowData[rowData.length - 1].equalsIgnoreCase(POINT_TYPE[12]) ) {
 ...
 public List<Double> getAbscissaForWireLineProjection(){
	 ...
	 MeasPoint leftUppestStart = getStartPillarLeftTheUppestMeasPointList().get(1);
	 MeasPoint mediumUppestStart = getStartPillarMediumTheUppestMeasPointList().get(1);
	 MeasPoint rightUppestStart = getStartPillarRightTheUppestMeasPointList().get(1);
	 MeasPoint leftMediumStart = getStartPillarLeftMediumMeasPointList().get(1);
	 MeasPoint rightMediumStart = getStartPillarRightMediumMeasPointList().get(1); 
	 MeasPoint startPillarBaseCenter = getStartPillarBaseTopData().get(0);
	 Arrays.asList(leftStart, mediumStart, rightStart, leftOutsideStart, leftInsideStart, rightInsideStart, rightOutsideStart, 
			 leftUppestStart, mediumUppestStart, rightUppestStart, leftMediumStart, rightMediumStart)
	 .forEach(measPoint -> {
	if( measPoint != null ) {
